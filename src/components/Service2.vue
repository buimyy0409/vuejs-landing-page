<script setup>
import mainPhoto from "../assets/images/service3.jpg";
import subPhoto1 from "../assets/images/service4.jpg";
import subPhoto2 from "../assets/images/service5.jpg";
import subPhoto3 from "../assets/images/service6.jpg";
          ...
          <div class="img-shadow">
            <div class="owl-single no-dots owl-carousel">
              ...
              <div class="item">
                ...
                <img :src="subPhoto1" alt="Image" class="img-fluid" />
              </div>
              <div class="item">
                <span class="number">{{ items[2].id }}/{{ total }}</span>
                <img :src="subPhoto2" alt="Image" class="img-fluid" />
              </div>
              <div class="item">
                <span class="number">{{ items[3].id }}/{{ total }}</span>
                <img :src="subPhoto3" alt="Image" class="img-fluid" />
              </div>
            </div>
          </div>
        </div>
